...
class DataProviderTest extends FunSuite {
  ...
  test("add one listener with dependency") {
    ...
    expect(List(listener1, listener2)) {
      provider.listeners
    }
  }
