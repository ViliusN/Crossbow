...
class TransformationTest extends FunSuite {
  test("TransformationN - name") {
    val target1 = new MutableIndicator[Int] { def name = "T1"; def dependencies = Empty }
    val target2 = new MutableIndicator[Int] { def name = "T2"; def dependencies = Empty }
    val target3 = new MutableIndicator[Int] { def name = "T3"; def dependencies = Empty }
    val transformed = new TransformationN(target1, target2, target3)(_ => None)
    expect("Transformation(T1;T2;T3)") { transformed.name }
  }
  ...
  test("TransformationN - dependencies") {
    ...
    val target3 = new MutableIndicator[Int] { def name = "T3"; def dependencies = Empty }
    val transformed = new TransformationN(target1, target2, target3)(_ => None)
    expect(Set(target1, target2, target3)) { transformed.dependencies }
  }
  ...
  test("TransformationN - calculation - one target") {
    ...
    target1.set(9)
    expect(Some(18)) { transformed() }
  }

  test("Transformation - name") {
    val target = new MutableIndicator[Int] { def name = "T"; def dependencies = Empty }
    val transformed = new Transformation(target)(_ => None)
    expect("Transformation(T)") { transformed.name }
  }

  test("Transformation - dependencies") {
    val target = new MutableIndicator[Int] { def name = "T"; def dependencies = Empty }
    val transformed = new Transformation(target)(_ => None)
    expect(Set(target)) { transformed.dependencies }
  }
  ...
  test("Transformation - calculation") {
    ...
    target.set(8)
    expect(Some(64)) { transformed() }
  }

  test("Transformation2 - name") {
    val target1 = new MutableIndicator[Int] { def name = "T1"; def dependencies = Empty }
    val target2 = new MutableIndicator[String] { def name = "T2"; def dependencies = Empty }
    val transformed = new Transformation2(target1, target2)((_, _) => None)
    expect("Transformation(T1;T2)") { transformed.name }
  }
  ...
  test("Transformation2 - dependencies") {
    ...
    val target2 = new MutableIndicator[String] { def name = "T2"; def dependencies = Empty }
    val transformed = new Transformation2(target1, target2)((_, _) => None)
    expect(Set(target1, target2)) { transformed.dependencies }
  }
  ...
  test("Transformation2 - calculation") {
    ...
    target1.set(9)
    target2.set("abc")
    expect(Some("abcabc81")) { transformed() }
  }

  test("Transformation3 - name") {
    val target1 = new MutableIndicator[Int] { def name = "T1"; def dependencies = Empty }
    val target2 = new MutableIndicator[String] { def name = "T2"; def dependencies = Empty }
    val target3 = new MutableIndicator[Double] { def name = "T3"; def dependencies = Empty }
  ...
  test("Transformation3 - calculation") {
    ...
    target2.set("abc")
    target3.set(0.5)
    expect(Some("abcabc9.5")) { transformed() }
  }
}
